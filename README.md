...
<img src="https://skillicons.dev/icons?i=firebase,aws,docker,kubernetes,bootstrap,tailwind,js,ts,react,jest,git,github,githubactions,py,nodejs,mysql,mongodb,nextjs,angular,express,wordpress,sass,gulp,redux,fastapi,postman,vite,jenkins,prometheus,grafana,ansible,linux,vercel,sequelize,nginx,androidstudio,bash,terraform" alt="skills" />
</div>
